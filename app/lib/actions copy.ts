...
const validateFormData = (Schema: SchemaProps, formData: FormData) => {
  return Schema.safeParse({
    ...
    price_special: Number(formData.get("price_special")),
...
export async function addProduct(
  ...
  try {
    await sql`
      ...
      VALUES  ('83850', 'Absolut', 'Absolut Vodka 1 Litre', 'Vodka 1 Litre', 'Spirits', 'Vodka', 76, 66, 0, 0, 700, 'ea', 4.75, 8, 'Bottle')
